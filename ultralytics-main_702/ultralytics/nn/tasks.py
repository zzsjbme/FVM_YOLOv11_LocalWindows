...
C3k2_CLASS=(C3k2_EBlock,C3k2_DBlock,C3k2_ODConv,C3k2_Faster,C3k2_RFAConv)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((Classify,
            ...
            A2C2f,)+C3k2_CLASS):
                ...
                n = 1
            if m is (C3k2,C3k2_CLASS):  # for M/L/X sizes
                legacy = False
                if scale in "mlx":
                    args[3] = True
            if m is A2C2f:
            ...
            c2 = ch[f] * 2
            args = [ch[f], c2, *args]
        elif m in {ECA,CoordAtt,GAM_Attention,CPCA,CoTAttention,BAMBlock,BiLevelRoutingAttention,TripletAttention,MPCA,SegNext_Attention,LocalWindowAttention}:
            c2 = ch[f]
            args = [c2, *args]
        elif m in {SimAM}:
            c2 = ch[f]
